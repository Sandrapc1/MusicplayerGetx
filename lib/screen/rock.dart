...
class RockSongs extends StatefulWidget {
  const RockSongs({super.key});

  @override
  State<RockSongs> createState() => _RockSongsState();
}

class _RockSongsState extends State<RockSongs> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
                    title: const Text('Rock Songs',style: TextStyle(color: bkclr),),
